...
print('Привет!')
print()
print('Ты попал во всем известную с детства игру "Морской бой"! Правила просты: "выбей" 10 кораблей')
print('(один четырёхпалубный, два трёхпалубных, три двухпалубных и четыре однопалубных) – и ты победил.')
print('Но не забывай, что количество ходов ограничено – их всего 50. Так что следи за этим, иначе, увы,')
print('проиграешь. Но гарантирую, что тебе этого числа хватит сполна :)')
...
while killed != 20 or shots != n:
	...
	if shots == n and killed != 20:
		print('Ты проиграл(а).')
		exit()
	elif int(killed) == 20 and shots <= n:
		print('Ты выиграл(а)!')
		exit()
